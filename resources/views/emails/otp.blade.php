...
<body>
   ...
   <div class="container">
       ...
       <p>  Your Otp: {!! $otp !!}</p>
       <p>This code is exclusively for your use to securely complete your action. Please keep it confidential.</p>
       <p>If you need assistance, our support team is here to help at yes@movira.llc.</p>
       <div class="footer">
           {!! $app_name !!}. All rights reserved.
       </div>
   </div>
