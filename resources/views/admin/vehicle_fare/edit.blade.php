                                ...
                                @if ($zone_price->price_type == 1)
                                    ...
                                    {{--Zone Prices--}}
                                        ...
                                        @php
                                            ...
                                            if($zone_price->zone_a || $zone_price->zone_b || $zone_price->zone_c){
                                                $zone_a = explode(',', $zone_price->zone_a);
                                                $zone_b = explode(',', $zone_price->zone_b);
                                                $zone_c = explode(',', $zone_price->zone_c);
                                            }
