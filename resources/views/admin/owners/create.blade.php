...
@section('content')
                ...
                <div class="page-title-right">
                    <ol class="breadcrumb m-0">
                        <li class="breadcrumb-item"><a
                                href="{{ url('owners/by_area',$area->id) }}">@lang('view_pages.manage_owner')</a>
                        </li>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-sm-6 float-left mb-md-3">
                                                            <div class="form-group">
                                                                <label
                                                                    for="company_name">@lang('view_pages.company_name')
                                                        ...
                                                        <div class="col-sm-6 float-left mb-md-3">
                                                            <div class="form-group">
                                                                <label for="owner_name">@lang('view_pages.owner_name')
                                                                    <span
                                                        ...
                                                        {{--<div class="col-sm-12 float-left mb-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <input type="hidden" class="form-control"
                                                                       id="address_lat" name="address_lat">
                                                                <input type="hidden" class="form-control"
                                                                       id="address_lng" name="address_lng">
                                                        ...
                                                        <div class="col-sm-6 float-left mb-md-3">
                                                            <div class="form-group">
                                                                ...
                                                                <select name="service_location_id"
                                                                    ...
                                                                    <option
                                                                        value="{{ $area->id }}" {{ old('service_location_id') == $area->id ? 'selected' : '' }}>{{ $area->name }}</option>
                                                                    {{-- @endforeach --}}
                                                                </select>
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div class="col-sm-6 float-left mb-md-3">
                                                            <div class="form-group">
                                                                <label for="tax_number">@lang('view_pages.tax_number')
                                                                    <span
                                                                        class="text-danger">*</span></label>
                                                ...
                                                <div class="tab-pane" id="bank-detail">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-6 float-left mb-md-3">
                                                            <div class="form-group">
                                                                <label
                                                                    for="bank_name">@lang('view_pages.bank_name')</label>
                                                                <input class="form-control" type="text"
                                                        ...
                                                        <div class="col-sm-6 float-left mb-md-3">
                                                            <div class="form-group">
                                                                <label
                                                                    for="account_no">@lang('view_pages.account_no')</label>
                                                            ...
                                                            <div class="col-sm-12 pb-3">
                                                                <div class="col-sm-6  float-left mb-md-3">
                                                                    <div class="form-group">
                                                                        <label for="name">@lang('view_pages.name') <span
                                                                                class="text-danger">*</span></label>
                                                                        <input class="form-control" type="text"
                                                                               name="doc_name" value="{{$item->name}}"
                                                                               placeholder="@lang('view_pages.document_name')"
                                                                               readonly>
                                                                    </div>
                                                                </div>
                                                                ...
                                                                @if ($item->has_expiry_date)
                                                                    <div class="col-sm-6 float-left mb-md-3">
                                                                        <div class="form-group">
                                                                            <label
                                                                                for="expiry_date">@lang('view_pages.expiry_date')
                                                                                <span
                                                                                    class="text-danger">*</span></label>
                                                                            <div id="datepicker"
                                                                                 class="date-pick input-group date date-custom"
                                                                                ...
                                                                                <input alt="" name="expiry_date[]"
                                                                                       ...
                                                                                       value="{{old('expiry_date.'.$key)}}"
                                                                                       autocomplete="off">
                                                                                <span class="input-group-addon"><i
                                                                                        class="fa fa-calendar"></i></span>
                                                                            </div>
                                                                            <span
                                                                                class="text-danger">{{ $errors->first('expiry_date.'.$key) }}</span>
                                                                        </div>
                                                                    </div>
                                                                @endif
                                                                ...
                                                                <div class="col-sm-6 float-left mb-md-3">
                                                                    <div class="form-group profile-img">
                                                                        <label>{{ trans('view_pages.document')}} <span
                                                                                class="text-danger">*</span></label>
    ...
    <script
        src="https://maps.google.com/maps/api/js?key={{get_settings('google_map_key')}}&libraries=drawing,geometry,places"></script>
    ...
    <!-- <script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDWu94bmxQVlHEcqfNpMLJs9IPlNzqNKik&libraries=places&callback=initMap" async defer></script> -->
