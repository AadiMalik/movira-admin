...
@endif -->
        ...
        @endif -->
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    @endif
                                    @if(auth()->user()->can('edit-drivers') && $result->is_tru_approve==0 && $result->is_tru_send==0)
                                    <a class="dropdown-item"
                                        href="{{ url('drivers/'.$result->id.'/send-tru') }}">
                                        <i class="fa fa-check-circle"></i> Send to TruDiligence
                                    </a>
                                    @endif
